...
var ScrapeAC = (function(){
    var baseURL        = 'https://www.aircraftclubs.com/functions/aircraft/getAircraft.php',
        ...
        oInjectQry     = {
            ...
            rowDataFiltered: "SELECT CONCAT({column_list}) AS data FROM {table} WHERE {where}",
        },//CONCAT(`SUBJECT`, ' ', `YEAR`)
        tables         = [],
        nQueryInterval = 2000,
        nMaxQuerys     = 200;
